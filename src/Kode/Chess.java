...
public class Chess extends JInternalFrame implements MouseListener, MouseMotionListener {
    ...
    private PawnB pawnS = new PawnB(new ImageIcon("src/Kode/Bilder/BondeS.png"));
    private PawnH pawnW = new PawnH(new ImageIcon("src/Kode/Bilder/BondeH.png"));
    private RookB rookB = new RookB(new ImageIcon("src/Kode/Bilder/TarnS.png"));
    private RookW rookW = new RookW(new ImageIcon("src/Kode/Bilder/TarnH.png"));
    private RookB rookBright = rookB;
    private RookB rookBleft = rookB;
    private RookW rookWleft = rookW;
    private RookW rookWright = rookW;
    private KnightB knightB = new KnightB(new ImageIcon("src/Kode/Bilder/HestS.png"));
    private KnightW knightW = new KnightW(new ImageIcon("src/Kode/Bilder/HestH.png"));
    private BishopB bishopB = new BishopB(new ImageIcon("src/Kode/Bilder/LoperS.png"));
    private BishopW bishopW = new BishopW(new ImageIcon("src/Kode/Bilder/LoperH.png"));
    private QueenB queenB = new QueenB(new ImageIcon("src/Kode/Bilder/DronningS.png"));
    private QueenW queenW = new QueenW(new ImageIcon("src/Kode/Bilder/DronningH.png"));
    private KingB kingB = new KingB(new ImageIcon("src/Kode/Bilder/kongeS.png"));
    private KingW kingW = new KingW(new ImageIcon("src/Kode/Bilder/kongeH.png"));
    ...
    public Chess() {
        ...
        chessBoard = new BoardPane("src/Kode/Bilder/sjakkbrett5.png");
        ...
        //Legger til brikker
        for (int i = 0; i < 8; i++) {
            PieceLabel test = new PieceLabel(pawnS.getIcon(), pawnS);
...
//        Setter Midlertidig ikon mens piecen blir move
    ...
    public void movepiece(MouseEvent e) {
        try {
            ...
            if (chessPiece.getPiece().equals(pawnS)) {
                ...
                if (pawnS.legalMove(e.getY() + yAdjustment, e.getX() + xAdjustment, startPos, m, team)) {
